...
set(Qt5Sql_VERSION_STRING 5.15.18)
...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/QtSql/5.15.18"
        "${_qt5Sql_install_prefix}/include/QtSql/5.15.18/QtSql"
    )
    ...
    foreach(_module_dep ${_Qt5Sql_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.18 ${_Qt5Sql_FIND_VERSION_EXACT}
