...
set(Qt5FbSupport_VERSION_STRING 5.15.18)
...
if (NOT TARGET Qt5::FbSupport)
    ...
    set(Qt5FbSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FbSupport_install_prefix}/include/QtFbSupport/5.15.18"
        "${_qt5FbSupport_install_prefix}/include/QtFbSupport/5.15.18/QtFbSupport"
    )
    ...
    foreach(_module_dep ${_Qt5FbSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.18 ${_Qt5FbSupport_FIND_VERSION_EXACT}
