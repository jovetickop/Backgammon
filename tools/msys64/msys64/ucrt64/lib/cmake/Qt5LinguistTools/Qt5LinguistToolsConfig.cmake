...
if (NOT TARGET Qt5::lrelease)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/bin/lrelease-qt5.exe")
...
if (NOT TARGET Qt5::lupdate)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/bin/lupdate-qt5.exe")
    _qt5_LinguistTools_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::lconvert)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/bin/lconvert-qt5.exe")
    _qt5_LinguistTools_check_file_exists(${imported_location})
