...
set(Qt5DBus_VERSION_STRING 5.15.18)
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/QtDBus/5.15.18"
        "${_qt5DBus_install_prefix}/include/QtDBus/5.15.18/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.18 ${_Qt5DBus_FIND_VERSION_EXACT}
