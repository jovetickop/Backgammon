...
set(Qt5PrintSupport_VERSION_STRING 5.15.18)
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/include/QtPrintSupport/5.15.18"
        "${_qt5PrintSupport_install_prefix}/include/QtPrintSupport/5.15.18/QtPrintSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PrintSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.18 ${_Qt5PrintSupport_FIND_VERSION_EXACT}
